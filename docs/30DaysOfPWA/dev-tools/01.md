...
| Section | Description |
| ------- | ----------- |
| **Introduction** | A quick intro into PWABuilder project |
...
<div align="center"> 
<img src="_media/homepage.png" width="800" alt="Enter a URL on the homepage" title="Enter a URL on the homepage"/>
</div>

You will be taken to this report card page that tells you your score for each component of the PWA.

<div align="center"> 
<img src="_media/URL_entered_homepage1.png" width="800" alt="Report card page on PWAbuilder.com" title="Report card page on PWAbuilder.com"/>
</div>

Under the tab “Manifest Options” you can add more details to your manifest. We also help you generate icons of all the sizes needed by the various app stores as well as screenshots that will appear on the PDP pages of all the app store. 
...
<div align="center"> 
<img src="_media/SWPage_4.png" width="800" alt="Edit your manifest on PWABuider.com" title="Edit your manifest on PWABuilder.com"/>
</div>
